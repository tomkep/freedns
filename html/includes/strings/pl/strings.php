...
$l["str_email_go_on_followin_page_to_recover"] = "Udaj się na tę tymczasową stronę, uzyskasz tam hasło. Uwaga: to jest jednorazowy link, można z niego skorzystać tylko raz!";
...
$l["str_lost_pwd_fill_in_fields_to_recover_password"] = "Nie pamiętasz hasła?<br>Wypełnij jedno z poniższych pól, wyślemy Ci URL-a, który pomoże Ci odzyskać hasło.";
...
$l["str_or_one_of_your_zones"] = "lub";
...
$l["str_primary_a_record_expl"] = "Jeśli chcesz dodać rekord A <b>dla samej strefy</b>, wpisz znak '@' (at).<br>Jeśli chcesz zrobić mapowanie jednej nazwy na <b>kilka podawanych na zmianę</b> adresów IP (aka Round Robin), to po prostu wpisz kilka rekordów A z taką samą nazwą i różnymi adresami IP.";
...
$l["str_primary_a_record_what_you_want_before_x_x_x"] = "Rekordy A przypisują nazwom adresy IP.<br> <b>Nazwa jest względna</b>, tj. tylko to, co chcesz mieć przed <i>%s</i>, jak <i>www</i> dla <i>www.%s</i>";
...
$l["str_primary_cname_expl"] = "Rekordy CNAME to definicje aliasów nazw.<br>Przykład: jeśli już istnieje rekord A <i>praca</i> wskazujący na adres IP <i>10.1.1.1</i>, to kolejna nazwa (np. <i>work</i>) wskazująca na ten sam adres IP powinna być rekordem CNAME wskazującym na istniejącą już nazwę (czyli na <i>praca</i>). Jest to pożyteczne, gdy masz wiele nazw dla tego samego adresu IP.<br> Reguły nazewnictwa <i>Aliasów</i> są takie same, jak dla nazw rekordów A.<br> Jeśli wskazywany rekord (<i>Nazwa</i>) jest poza bieżącą strefą, musisz użyć <b>nazwy bezwzględnej</b> z kropką na końcu. Jeśli wskazywany rekord (<i>Nazwa</i>) jest wewnątrz bieżącej strefy, to nie musisz dodawać domeny (a jak dodasz, to musisz zakończyć kropką).<br>Jeśli chcesz przechwycić wszystkie odwołania do strefy, należy użyć <b>CNAME wieloznacznego</b> (znak '*'). Musisz jednak być świadom tego, co robisz, zanim dodasz taki rekord.<br>Nie wolno utworzyć aliasu CNAME dla samej domeny.";
...
$l["str_primary_ipv6_record_expl_before_x_x_x"] = "Rekordy AAAA przypisują nazwom adresy IPv6. <b>Nazwa jest względna</b>, tj. tylko to, co chcesz mieć przed <i>%s</i>, jak <i>www</i> dla <i>www.%s</i>";
$l["str_primary_ipv6_record_expl_zone_and_round_robin"] = "Jeśli chcesz dodać rekord AAAA <b>dla samej strefy</b>, wpisz znak '@' (at).<br>Jeśli chcesz zrobić mapowanie jednej nazwy na <b>kilka podawanych na zmianę</b> adresów IP (aka Round Robin), to po prostu wpisz kilka rekordów AAAA z taką samą nazwą i różnymi adresami IP.<br>Uwaga! Nie działa (jeszcze) modyfikacja PTR dla stref podstawowych w tym serwisie.";
...
$l["str_primary_mx_expl_with_sample_x"] = "Rekordy MX wskazują, jakie <i>serwery poczty</i> obsługują pocztę dla <i>nazwa</i>. <i>Nazwa</i> to albo znak '@' bezpośrednio dla samej domeny, albo nazwa jednego komputera czy poddomeny, dla której chcemy zrobić oddzielny <i>serwer poczty</i>. <br>Jako <i>serwer poczty</i> musisz użyć <b>nazwy bezwzględnej</b> komputera, razem z <b>końcową kropką</b> (np. <i>mail.%s.</i>), <b>nie</b> adres IP.";
...
$l["str_primary_soa_fixed_x"] = "poprawione z %s";
...
$l["str_primary_srv_record_expl"] = "Nazwy rekordów SRV powstają ze sklejenia nazwy usługi, protokołu (tcp lub udp) i nazwy domeny (w bieżącej strefie). Np. <i>_sip._tcp</i> dla rekordu SRV dla VoIP. Użyj parametru <i>Port</i> dla wyszczególnienia, na który port na serwerze docelowym należy się łączyć z tą usługą.";
...
$l["str_records_count"] = "Liczba rekordów";
